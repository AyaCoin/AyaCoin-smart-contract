...
contract AyaCoin is StandardToken{
    using SafeMath for uint256;

    string public name = "AyaCoin";
    ...
    /**
     * This function would be called if whitelisted users sent ETH to buy the tokens.
     * 
     * We will calculate the amount of tokens and send to their wallets.
     */
    ...
    /**
     * Calculates the total amount of tokens
     */
    ...
    /**
     * Investors can buy at least 1 token.
